...
export const styleTouchableViewRecords = StyleSheet.create(touchableViewRecords);
export const styleTouchableViewImageRecords = StyleSheet.create(touchableViewImageRecords);
export const styleTouchableNameRecords = StyleSheet.create(touchableNameRecords);
export const styletouchableAddressRecords = StyleSheet.create(touchableAddressRecords);
export const styleTouchableDescriptionRecordsRecords = StyleSheet.create(touchableDescriptionRecords);
